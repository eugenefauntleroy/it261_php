...
if(isset($_GET['today'])) {
    ...
    switch($today) {
        ...
        case 'Monday' :
        $flag = '<h2>Algerian</h2>';
        $pic = 'weeks/week3/switch_pics/ag-flag.jpg';
        $alt = 'Algeria';
        ...
        case 'Tuesday' :
        $flag = '<h2><Armenian/h2>';
        $pic = 'weeks/week3/switch_pics/am-flag.jpg';
        $alt = 'Armenia';
        ...
        case 'Wednesday' :
        $flag = '<h2>Andorran</h2>';
        $pic = 'weeks/week3/switch_pics/an-flag.jpg';
        $alt = 'Andorra';
        ...
        case 'Thursday' :
        $flag = '<h2>Angolan</h2>';
        $pic = 'weeks/week3/switch_pics/ao-flag.jpg';
        $alt = 'Angola';
        ...
        case 'Friday' :
        $flag = '<h2>Austrian</h2>';
        $pic = 'weeks/week3/switch_pics/au-flag.jpg';
        $alt = 'Austria';
        ...
        $pic = 'weeks/week3/switch_pics/tn_ar-flag.jpg';
        $alt = 'Argentina';
...
<img src="week3/switch_pics/<?php echo $pic;?>" alt="<?php echo $alt; ?>">
<?php echo $content;?>
